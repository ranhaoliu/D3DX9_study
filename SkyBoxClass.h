...
public:
	...
	BOOL	LoadSkyTextureFromFile(const char* pFrontTextureFile, const char* pBackTextureFile, const char* pLeftTextureFile, const char* pRightTextureFile, const char* pTopTextureFile);  //从文件加载天空盒五个方向上的纹理
