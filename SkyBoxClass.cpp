...
// Desc: 天空盒纹理加载函数
//-------------------------------------------------------------------------------------------------
BOOL SkyBoxClass::LoadSkyTextureFromFile( const char* pFrontTextureFile, const char* pBackTextureFile, const char* pLeftTextureFile, const char* pRightTextureFile,const char* pTopTextureFile)
{
	//从文件加载五张纹理
